...
export default function Dashboard({ hackathon }: DashboardProps) {
  ...
  const filteredAndSortedProjects = useMemo(() => {
    ...
    const filtered = sourceProjects.filter((project) => {
      ...
      return matchesSearch && matchesTrack && matchesCountry && matchesTeamSize && matchesUniversity && matchesLinks;
    });
  ...
  }, [searchTerm, selectedTracks, selectedCountries, sortBy, mappedProjects, shuffledProjects, teamSizeRange, showUniversityOnly, hasLinks]);
